...
const APARTMENT_SCENE = preload("res://scenes/apartment_root.tscn")
...
var story_slides: Array = [
	{
		...
		"image": "res://images/places/stairs_1.png",
		"audio": "res://audio/intro/step_1.wav",
		"sfx": "res://audio/Environment/step-1.wav"
	},
	{
		...
		"image": "res://images/places/stairs_2.png",
		"audio": "res://audio/intro/step_2.wav",
		"sfx": "res://audio/Environment/step-2.wav"
	},
	{
		...
		"image": "res://images/places/stairs_3.png",
		"audio": "res://audio/intro/step_3.wav",
		"sfx": "res://audio/Environment/step-3.wav"
	},
	{
		...
		"image": "res://images/places/stairs_door_302.png",
		"audio": "res://audio/intro/step_4.wav",
		"sfx": "res://audio/Environment/step-4.wav"
	}
]
...
func _end_backstory() -> void:
	...
	get_tree().change_scene_to_packed(APARTMENT_SCENE)
